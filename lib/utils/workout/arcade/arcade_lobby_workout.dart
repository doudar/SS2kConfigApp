...
class ArcadeLobbyWorkout {
  ArcadeLobbyWorkout({required this.content, required this.source})
  ...
  static Future<List<ArcadeLobbyWorkout>> loadChoices() async {
    final choices = <ArcadeLobbyWorkout>[];
    void add(String content, String source) {
      try {
        final choice = ArcadeLobbyWorkout(content: content, source: source);
